...
//                         alt="Driver Icon"
                    ...
                    //         <div>
                    //             <h3 className="text-lg font-medium">Pickup Location</h3>
                    //             <p className="text-sm font-medium text-gray-600">{props.pickup}</p>
                    //         </div>
                    //     </div>
                    //     <div className="flex items-center gap-4 p-3 border-b">
                    ...
                    //         <div>
                    //             <h3 className="text-lg font-medium">Drop Location</h3>
                    //             <p className="text-sm font-medium text-gray-600">{props.destination}</p>
                    //         </div>
                    //     </div>
                    ...
                    //         <div>
                    //             <h3 className="text-lg font-medium">₹{props.fare[props.vehicleType]}</h3>
                    //             <p className="text-sm font-medium text-gray-600">By Cash</p>
                    //         </div>
//                         </div>
//                     </div>
//                 </div>
