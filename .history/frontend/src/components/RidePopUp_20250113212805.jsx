        ...
        <div className='w-full mt-5'>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              ...
              <p className='text-sm font-medium -mt-1 text-gray-600'>{props.ride?.pickup}</p>
            </div>
          </div>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              ...
              <p className='text-sm font-medium -mt-1 text-gray-600'>{props.ride?.destination}</p>
            </div>
          </div>
          <div className='flex items-center gap-5 p-3'>
            ...
            <div>
              ...
              <p className='text-sm font-medium -mt-1 text-gray-600'>Cash Cash</p>
            </div>
          </div>
        </div>
